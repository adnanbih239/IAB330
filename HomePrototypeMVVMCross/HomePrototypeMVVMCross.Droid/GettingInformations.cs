...
{
    [Activity(Label = "GettingInformations")]
    public class GettingInformations : DialogFragment
    {
        ...
        {
            View view = inflater.Inflate(Resource.Layout.getInformations, container, false);
